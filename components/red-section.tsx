  ...
  return (
    <section className="min-h-screen py-24 px-6 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        {/* Section header */}
        <div className="mb-16">
          <h2 className="font-clash text-5xl md:text-7xl font-bold text-black mb-4 leading-tight">
            LA RED DE SEGURIDAD
          </h2>
          <p className="font-clash text-xl md:text-2xl text-vital font-semibold">Servicios Médicos</p>
          <p className="font-clash text-lg text-black/70 mt-4 max-w-2xl leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          <div className="bg-white/80 backdrop-blur-sm rounded-[32px] p-8 md:p-12 shadow-brutal border-4 border-red-200 hover:translate-x-1 hover:translate-y-1 transition-transform">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {testimonials.map((testimonial, index) => (
            <div
              ...
              className="group relative bg-white/80 backdrop-blur-xl rounded-[32px] p-8 shadow-brutal border-4 border-red-200 overflow-hidden transition-all hover:scale-[1.02]"
              style={{
            ...
            >
              ...
              <div
                className={`absolute inset-0 bg-gradient-to-br from-red-50/50 to-transparent transition-opacity duration-500 ${hoveredIndex === index ? "opacity-100" : "opacity-0"
                  }`}
              />
              ...
              <div className="relative z-10">
                ...
                >
                  ...
                  <p className="font-inter text-base text-black/60 tracking-normal">{testimonial.location}</p>
                </div>
              </div>
            </div>
          ))}
