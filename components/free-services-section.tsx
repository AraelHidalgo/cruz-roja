    ...
    <section ref={sectionRef} className="py-32 px-6 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-20">
          ...
          >
            <div className="bg-white text-vital px-8 py-3 rounded-full border-4 border-white shadow-brutal transform -rotate-2">
              <span className="font-inter text-base uppercase tracking-[0.1em] font-bold">MITO DESTRUIDO</span>
            </div>
          </div>

          <h2
            className={`font-clash text-5xl md:text-8xl font-bold text-black mb-8 leading-[0.9] transition-all duration-1000 delay-200 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"
              }`}
          >
          ...
          <p
            className={`font-inter text-xl md:text-2xl text-black/80 max-w-3xl mx-auto leading-relaxed transition-all duration-1000 delay-400 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
              }`}
          >
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {freeServices.map((service, index) => (
            <div
              key={service.title}
              className={`bg-white/80 backdrop-blur-sm rounded-[24px] p-8 border-4 border-red-300/50 shadow-brutal hover:shadow-brutal-lg hover:-translate-y-2 transition-all duration-300 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"
                }`}
              style={{
            ...
            >
              ...
              <h3 className="font-clash text-2xl font-bold text-black mb-2">{service.title}</h3>
              <p className="font-inter text-base text-black/70 mb-4 leading-relaxed tracking-normal">{service.description}</p>
              <div className="inline-block bg-vital text-white px-4 py-2 rounded-lg text-sm font-bold uppercase tracking-[0.08em]">
                {service.detail}
              </div>
            </div>
          ))}
        ...
        >
          <div className="bg-white/70 backdrop-blur-sm border-4 border-red-300/50 rounded-[32px] p-8 md:p-12 inline-block">
            <p className="font-inter text-lg md:text-xl text-black/80 leading-relaxed max-w-2xl mb-4">
            ...
            <p className="font-inter text-lg md:text-xl text-black/80 leading-relaxed max-w-2xl">
