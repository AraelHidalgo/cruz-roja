        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          <div className="bg-white/90 backdrop-blur-sm rounded-[32px] p-8 md:p-10 shadow-brutal border-4 border-white hover:translate-x-1 hover:translate-y-1 transition-transform">
            <div className="flex items-start justify-between mb-6">
              <span className="font-mono text-xs uppercase tracking-wider text-black/60 bg-red-100 px-3 py-1 rounded-full">
                CURSO BÁSICO
              </span>
              <span className="font-mono text-xs text-black/60">4 horas</span>
            </div>
            <h3 className="font-clash text-2xl md:text-3xl font-bold mb-4 text-black">Primeros Auxilios</h3>
          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-[32px] p-8 md:p-10 shadow-brutal border-4 border-white hover:translate-x-1 hover:translate-y-1 transition-transform">
            <div className="flex items-start justify-between mb-6">
              ...
              <span className="font-mono text-xs text-black/60">8 horas</span>
            </div>
            <h3 className="font-clash text-2xl md:text-3xl font-bold mb-4 text-black">Respuesta ante Emergencias</h3>
            <ul className="space-y-3 font-inter text-base text-black/70">
              <li className="flex items-start gap-3">
                <span className="text-vital font-bold">→</span>
